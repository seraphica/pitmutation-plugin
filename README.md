This is `Work In Progress` version of jenkins plugin for pit mutation. I have used `pitmutation-jenkins` project as a base for my own researches of plugin that suites my needs.
